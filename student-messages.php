...
// Prepare and execute a SQL query to fetch messages where the receiver_id matches the logged-in user's ID
$query = "SELECT * FROM messages WHERE resiver_id = ? AND approved = 1  ";
$stmt = $conn->prepare($query);
$stmt->bind_param("i", $loggedInUserId);
$stmt->execute();
$result = $stmt->get_result();

// Display messages where the receiver_id matches the logged-in user's ID
...
<head>
    ...
    <!-- Title -->
    <title> Perth Tutors | Student Messages </title>
    <meta property="og:title" content="Perth Tutors | Student Messages" />
    <meta name="twitter:title" content="Perth Tutors | Student Messages" />
    ...
    <div id="dh-website">
        <main>
            <div class="t2422 dh-body">
                ...
                <section class="t2423">
                    <container class="t2424">
                        <div class="t2425">
                            <h1 class="t2426">Student's Message</h1>
                            <p class="t2427">You have received the following message from the students:</p>
                            <?php
    ...
    while ($row = $result->fetch_assoc()) {
        ?>
                            <div class="t2428">
                                <div class="t2429">
                                    <p class="t2502">
                                        <b class="t2503">Recent Messages</b>
                                    </p>
                                    <div class="t2454">
                                        <div class="t2458">
                                            <span class="t2460">Student Name: </span>
                                            <span class="t2459">Jack Brook</span>
                                        </div>
                                        <div class="t2470">
                                            <span class="t2471">Location: </span>
                                            <span class="t2472">West Bank</span>
                                        </div>
                                        <div class="t2473">
                                            <span class="t2474">Date:</span>
                                            <span class="t2475">12-Dec. 2023</span>
                                        </div>
                                        <div class="t2464">
                                            <span class="t2465">Subject: </span>
                                            <span class="t2466">English</span>
                                        </div>
                                        <div class="t2455">
                                            <span class="t2456">Phone: </span>
                                            <span class="t2457">03401029484</span>
                                        </div>
                                        <div class="t2467">
                                            <span class="t2468">Email: </span>
                                            <span class="t2469">example@gmail.com</span>
                                        </div>
                                        <div class="t2535">
                                            <span class="t2536">Tutoring Mode: </span>
                                            <span class="t2537">Online / In-person</span>
                                        </div>
                                        <div class="t2461">
                                            <span class="t2462">Message: </span>
                                            <p class="t2463">Hi,  I am looking for an English tutor for my son who is in year 5.</p>
                                        </div>
                                        <div class="t2476">
                                            <a class="t2477 button-tertiary">Chat with Student</a>
                                        </div>
                                    </div>
                                    <?php }} ?>
