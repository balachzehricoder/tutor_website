...
<head>
    ...
    <!-- Title -->
    <title> Perth Tutors | Blog </title>
    <meta property="og:title" content="Perth Tutors | Blog" />
    <meta name="twitter:title" content="Perth Tutors | Blog" />
...
<body>
    ...
    <div id="dh-website">
        ...
        <section class="t2712">
          <container class="t2713">
            <div class="t2714">
              <h2 class="t2716">
                <span class="t2718">Our </span>
                <span class="t2717">Blog</span>
              </h2>
              <p class="t2715">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            </div>
            <div class="t2719">
...
include("config.php");
    $query = "SELECT * FROM blogs "; // Replace 'your_table_name' with your actual table name
           ...
           $createdAt = $row['created_at']
            ...
            ?>
             <!-- div Start -->
              ...
              <div class="t2739">
                <a page-id="30" href="blog-details.php?id=<?php echo $id ?>" class="t2740">
                  <div class="t2741">
                    <img src="admin/blogs/<?php echo $image_path ?>" loading="lazy" alt="null"
                      class="t2742">
                  </div>
                  <div class="t2743">
                    <div class="t2744">
                      <h4 class="t2745"><?php echo $Title ?></h4>
                      <p class="t2746 short-p"><?php echo $content ?></p>
                    </div>
                  </div>
                </a>
                <p class="t2747 short-p">
                  <span class="t2750"><?php echo $createdAt ?> </span>
                  <a class="t2748">
                    <span class="t2749">Learning Category</span>
                  </a>
                </p>
                
                <div class="t2751">
                  <a page-id="30" href="blog-details.php?id=<?php echo $id ?>" class="t2752">Read more</a>
                </div>
              </div>
              <!-- div end -->
              <?php }} ?>
              ...
              <div class="t133">
                <div class="t135">
                  ...
                  <div class="t147">
                    ...
                    <a class="t148">
                      <img src="assets/3ce8823419a832a06bd4d16130a68d60_1415.svg" loading="lazy" alt="null"
                        class="t149">
                    </a>
                    <a class="t148">
                      <img src="assets/f96f5a08c1c7531a9bbedae562cfc8c9_3216.svg" loading="lazy" alt="null"
                        class="t149">
                    </a>
                  </div>
                  <div class="t93">
                    ...
                    <a page-id="6" href="become-tutor.html" class="t582 button-tertiary button-tertiary">Become
                      Tutor</a>
                  </div>
                </div>
                <div class="t145">
                  <div class="t319">
                    ...
                    <p class="t146">We are always open to discuss your project, improve your online presence and help
                      with your UX/UI design challenges.</p>
                  </div>
                  <div class="t583">
                    <a href="tel:+61340204345" link-type="phone" class="t543">
                      <ul class="t299">
                        <li class="t300">
                          <img src="assets/e7a3345498a02da8b46d2a24af2a7d8b_506.svg" loading="lazy" alt="null"
                            class="t301">
                    ...
                    <a href="tel:+61340204345" link-type="phone" class="t543">
                      <ul class="t299">
                        <li class="t300">
                          <img src="assets/b6e20c909b9d9009baed735e5659e56b_1024.svg" loading="lazy" alt="null"
                            class="t301">
                          <span class="t544">034 02 04 345</span>
                        </li>
                      </ul>
                    ...
                    <a href="mailto:contact@perthtutorswa.com" link-type="email" target="_BLANK" class="t543">
                      <ul class="t299">
                        <li class="t300">
                          <img src="assets/4059607622aab9fa33b7de5860fe6bba_353.svg" loading="lazy" alt="null"
                            class="t301">
