                ...
                <section class="t2509">
                    <container class="t2510">
                        <div dh-transform="simple-animations" dh-transform-options="a:fadeInUp|b:0|c:0|d:600" class="t2530">
                            <h2 class="t2531">
                                <span class="t2533">Tutors avialabe at </span>
                                <span class="t2532">In Locaiton A</span>
                            </h2>
...
include("config.php");
    $query = "SELECT * FROM tutor_info WHERE location = 'Alexander Heights' ;
        ...
        foreach ($result as $row) {
            ...
            ?>
                           ...
                           <!-- div start -->
                            <div class="t2512">
                                <div class="t2515">
                                    <img src="<?php echo $image ?>" loading="lazy" alt="null" class="t2522">
                                    <div class="t2516">
                                ...
                                <div class="t2523">
                                    <h4 class="t2524"><?php echo $Name ?></h4>
                                    <p class="t2525"><?php echo $bio ?></p>
                                </div>
                                <div class="t2513">
